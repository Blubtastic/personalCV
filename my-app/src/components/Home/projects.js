    ...
    return(
      <div className="column projects-container page-section secondary inner-shadow" id="work">
        ...
        <div className="projects">
            <Project link={"https://www.martinstor.no"} image={this_site} title={"REACT: "} title2={"This webpage"} description={"This site is developed in React using mostly plain HTML, CSS & Javascript. It is created and designed by me, and is hosted at github pages. "} />
            ...
            <Project image={bachelor} title={"BACHELOR: "} title2={"Machine learning"} description={"A desktop application made for discovering unregistered quarries by systematically scanning satelite photos using a trained Neural Network"} />
            <Project  image={angular} title={"ANGULAR: "} title2={"Shopping website"} description={"A full stack shopping website solution made in Angular. Node.js was used for the backend, and MongoDB as the database."} />
